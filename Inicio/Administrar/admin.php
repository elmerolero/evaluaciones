<?php
  ...
  $comandoConsulta = "SELECT Nombre_Evaluacion, Ruta_Seguimiento FROM Evaluaciones WHERE Disponible = 1";
  ...
  else
  {
      ...
      $datos['exitoso'] = true;
  		...
  		{
        // Asigna el nombree
  			$datos[$i]['Nombre'] = $evaluaciones['Nombre_Evaluacion'];

        // Asigna la ruta de seguimiento
        $datos[$i]['Ruta_Seguimiento'] = $evaluaciones['Ruta_Seguimiento'];
